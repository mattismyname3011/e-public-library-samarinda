(() => {
  ...
  function Q(e, t) {
    return (
      Object.entries(Rt).forEach(([r, n]) => {
        Object.defineProperty(e, `$${r}`, {
          get() {
            return n(t, { Alpine: S, interceptor: de });
          },
          enumerable: !1,
        });
      }),
...
`,
  ...
  function Vr(e) {
    return ({ name: t, value: r }) => {
      let { name: n, value: i } = Lt.reduce((o, s) => s(o), {
        name: t,
        value: r,
      });
  ...
  function Ee(e = !1, t = !1) {
    return function (n, i, o) {
      ...
      if (i === "__v_raw" && o === (e ? (t ? hn : sr) : t ? mn : or).get(n))
        return n;
      let s = D(n);
      if (!e && s && te(Se, i)) return Reflect.get(Se, i, o);
      let a = Reflect.get(n, i, o);
      return (be(i) ? ir.has(i) : ln(i)) || (e || w(n, "get", i), t)
        ? a
        : lt(a)
        ? !s || !ve(i)
          ? a.value
  ...
  function cr(e = !1) {
    return function (r, n, i, o) {
      let s = r[n];
      if (!e && ((i = g(i)), (s = g(s)), !D(r) && lt(s) && !lt(i)))
        return (s.value = i), !0;
      let a = D(r) && ve(n) ? Number(n) < r.length : te(r, n),
        c = Reflect.set(r, n, i, o);
      return (
        r === g(o) &&
          (a ? ot(i, s) && P(r, "set", n, i, s) : P(r, "add", n, i)),
        c
      );
    };
  }
  ...
  var lr = { get: un, set: gn, deleteProperty: yn, has: xn, ownKeys: bn },
    ur = {
      get: dn,
      set(e, t) {
        return (
  ...
  function Re(e, t = !1) {
    return (
      (e = e.__v_raw), !t && w(g(e), "iterate", F), Reflect.get(e, "size", e)
    );
  }
  function fr(e) {
    e = g(e);
  ...
  function pr(e, t) {
    ...
    return (
      r.set(e, t),
      o ? ot(t, s) && P(r, "set", e, t, s) : P(r, "add", e, t),
      this
    );
  }
  function mr(e) {
  ...
  function Me(e, t) {
    return function (n, i) {
      let o = this,
        ...
        c = t ? dt : e ? ft : ut;
      return (
        !e && w(a, "iterate", F), s.forEach((l, u) => n.call(i, c(l), c(u), o))
      );
    };
  }
  function Ne(e, t, r) {
    ...
    return function (...t) {
      {
        ...
        console.warn(
          `${it(e)} operation ${r}failed: target is readonly.`,
          g(this)
        );
      }
  ...
  function ke(e, t) {
    ...
    return (n, i, o) =>
      i === "__v_isReactive"
        ...
        : i === "__v_raw"
        ? n
        : Reflect.get(te(r, i) && i in n ? r : n, i, o);
  }
  var wn = { get: ke(!1, !1) },
    go = { get: ke(!1, !0) },
    En = { get: ke(!0, !1) },
  ...
  function Er(
    e,
    t,
    { during: r, start: n, end: i, entering: o } = {},
    s = () => {},
    a = () => {}
  ) {
    if (
  ...
  function le(e, t, r, n) {
    let i = e,
      ...
      a = (c, l) => (u) => l(c, u);
    if (
      (r.includes("dot") && (t = Vn(t)),
      r.includes("camel") && (t = Hn(t)),
  ...
  function Wn(e, t) {
    ...
    if (r.length === 0 || (r.length === 1 && Tr(e.key).includes(r[0])))
      return !1;
  ...
  function ei(e, t, r, n) {
    let i = (s) => typeof s == "object" && !Array.isArray(s),
      o = e;
    r((s) => {
      ri(s) && s >= 0 && (s = Array.from(Array(s).keys(), (f) => f + 1)),
        s === void 0 && (s = []);
      let a = e._x_lookup,
        c = e._x_prevKeys,
        l = [],
  ...
  p(
    "on",
    U((e, { value: t, modifiers: r, expression: n }, { cleanup: i }) => {
      let o = n ? h(e, n) : () => {},
        s = le(e, t, r, (a) => {
  ...
  S.setEvaluator(Ue);
  S.setReactivityEngine({ reactive: Ae, effect: er, release: rr, raw: g });
  var ht = S;
  window.Alpine = ht;
  queueMicrotask(() => {
    ht.start();
